...
export default function ProductPage() {
  ...
  const gridColsXL = relatedProducts.length >= 5
  ? 5
  ...
  return (
    <div className="min-h-screen ml-10 xl:ml-0 flex flex-col justify-start px-6 gap-30 xl:px-40 py-5">
      ...
      <div className="flex flex-col gap-5 xl:w-1/2 pt-4 max-w-xl">
        ...
        <p className="text-gray-500 text-xl mb-5">{product.description}</p>
        ...
        <div className="flex flex-col gap-2 text-gray-500 font-medium text-lg">
      ...
      <div className="flex flex-col">
        ...
        <div className="border border-gray-200 w-fit p-10">
          <p className="text-lg text-gray-600 font-medium">An e-commerce website is an online platform that facilitates the buying and selling of products or services over the internet. It serves as a virtual marketplace where businesses and individuals can showcase their products, interact with customers, and conduct transactions without the need for a physical presence. E-commerce websites have gained immense popularity due to their convenience, accessibility, and the global reach they offer. <br />
          <br />
      ...
      <div className="flex flex-col justify-center items-center mt-10">
        ...
        <div className={`grid grid-cols-2 xl:grid-cols-${gridColsXL} gap-5 mt-4`}>
