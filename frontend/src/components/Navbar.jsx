...
const Navbar = () => {
  ...
  return (
    <header className="w-full p-7 relative">
        <div className={`flex justify-between xl:mx-32 ${notHome ? "pb-7 border-b-[3px] border-gray-200" : ""}`}>
            <NavLink to="/">
            ...
            <div className="hidden xl:flex justify-center items-center gap-7 font-medium text-[18px]">
                ...
                <NavLink to="/admin"className="border border-gray-300 px-2 py-1 rounded-4xl px-6 py-3 text-sm"> Admin Panel</NavLink>
