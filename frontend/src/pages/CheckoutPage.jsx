...
const DeliveryPage = () => {
  ...
  const handleClick = (method) => {
    {method === "stripe" || method === "razorpay"
      ? toast.error(`${method} is disabled for now, use COD`, {
        icon: "⚠️",
        style: {
          background: "#FFFFFF",
          color: "#991b1b",
      ...
      <div className="w-3/4 mt-15 text-lg ml-auto">
        ...
        <div className="flex flex-col mt-10">
          ...
          <div className="flex mt-15 justify-end">
            <button className="w-1/3 xl:w-1/2 bg-black text-white py-4 text-sm xl:text-lg font-medium hover:bg-gray-800 transition cursor-pointer">
              PLACE ORDER
            </button>
          </div>
        </div>
