...
//           <h2 className="text-lg xl:text-xl text-gray-700 font-medium">{product.item.name}</h2>
...
const ProductCart = (product) => {
  ...
  return (
    <div className="flex justify-between gap-8 xl:gap-0 items-center w-full border-t border-b border-gray-200 py-2">
      ...
      <div className="flex">
        ...
        <div className="flex flex-col justify-center">
          ...
          <div className="flex items-center mt-6">
            <h2 className="text-base xl:text-lg text-gray-700 font-medium">£{product.item.price}</h2>
            <h2 className="text-md xl:text-lg text-gray-700 font-medium ml-5 bg-gray-100 border border-gray-300 px-2 py-1">{product.item.size}</h2>
          </div>
        </div>
      </div>
